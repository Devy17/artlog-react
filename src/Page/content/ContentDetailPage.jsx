    ...
    <div className={style['content-detail-page-wrapper']}>
      ...
      <div className={style['main-content']}>
        ...
        <CardMedia
          ...
          onError={(e) => { // 이미지 로딩 오류 시 대체 이미지 표시
        ...
        <div> {/* 이 div 자체는 SCSS 클래스 없어도 됩니다 */}
           ...
           <div className={style['content-details-container']}>
              ...
              {/* 기간 정보 항목 */}
              <div className={style['detail-item']}> {/* ✅ SCSS 클래스 적용 */}
                <div className={style['detail-label']}>기간</div> {/* ✅ 라벨 SCSS 클래스 적용 */}
                <div className={style['detail-value']}> {/* ✅ 값 SCSS 클래스 적용 */}
              ...
              {/* 장소 정보 항목 */}
              <div className={style['detail-item']}> {/* ✅ SCSS 클래스 적용 */}
                <div className={style['detail-label']}>장소</div> {/* ✅ 라벨 SCSS 클래스 적용 */}
                <div className={style['detail-value']}>{searchParams.get('venue')}</div> {/* ✅ 값 SCSS 클래스 적용 */}
              </div>
              {/* 관람료 정보 항목 */}
              <div className={style['detail-item']}> {/* ✅ SCSS 클래스 적용 */}
                <div className={style['detail-label']}>관람료</div> {/* ✅ 라벨 SCSS 클래스 적용 */}
                <div className={style['detail-value']}> {/* ✅ 값 SCSS 클래스 적용 */}
              ...
              {/* 상세페이지 링크 항목 */}
              <div className={style['detail-item']}> {/* ✅ SCSS 클래스 적용 */}
                <div className={style['detail-label']}>상세페이지</div> {/* ✅ 라벨 SCSS 클래스 적용 */}
                <div className={style['detail-value']}> {/* ✅ 값 SCSS 클래스 적용 */}
      ...
      <div className={style['reviews-section']}> {/* ✅ SCSS 클래스 적용 */}
